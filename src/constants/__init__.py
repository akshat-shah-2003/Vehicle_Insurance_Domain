...
MONGODB_URL_KEY = f"mongodb+srv://akshats1607_db_user:{DATABASE_PASSWORD}@asvehiclecluster.42dz4re.mongodb.net/?retryWrites=true&w=majority&appName=ASVehicleCluster"
